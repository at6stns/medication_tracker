...
ActiveRecord::Schema[8.1].define(version: 2026_06_07_102325) do
  ...
  create_table "medication_records", force: :cascade do |t|
    ...
    t.boolean "taken"
    t.datetime "updated_at", null: false
    t.index ["dosage_id"], name: "index_medication_records_on_dosage_id"
    t.index ["medication_id"], name: "index_medication_records_on_medication_id"
    t.index ["record_id"], name: "index_medication_records_on_record_id"
  end
  ...
  add_foreign_key "medication_records", "dosages"
  add_foreign_key "medication_records", "medications"
  add_foreign_key "medication_records", "records"
