...
## アプリ概要
服薬予定の内服薬やサプリメントの登録、服用記録の登録、及び服用履歴の閲覧ができるサービス


## 開発背景
調剤薬局での勤務を通じて、複数の医療機関から多くのお薬を処方されている患者様が多いことに気づいた。その中で、「お薬をよく飲み忘れる」、「どれが何の薬か分からなくなる」とおっしゃる方々も少なくない。そこで、服用のチェック及び、体調の変化などを手軽に記録・可視化できるシンプルなアプリを開発しようと考えた。それにより、患者様の服用状況や体調の把握が容易になるため、安全にお薬を飲んでいただけるのではないか。また、薬局側も、重複投与や相互作用による医師への疑義照会の手間を省ける可能性が高まり、待ち時間の短縮にも繋がるため、円滑な薬局運営も期待できる。これらの背景から、私は服薬管理アプリである「くすログ」を開発した。
